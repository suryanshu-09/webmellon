...
//   return (
//     <Tabs defaultValue="yt" className="w-[80vw] sm:w-[600px] overflow-hidden">
//       <TabsList className="sm:grid w-full sm:grid-cols-3 scroll-auto">
...
export function EditFeed() {
  ...
  return (
    <Tabs defaultValue="yt" className="w-full">
      {/* Tabs trigger — only visible on sm and up */}
